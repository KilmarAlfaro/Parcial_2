...
podemos enviar instrucciones a nuestra base de datos (este caso mysql) para hacer uso del insert, delete, select 
entre otras funciones relacionadas a las bases de datos
"""
cursor = db.cursor()
